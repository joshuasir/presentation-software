...
const MusicItem = ({ musicId, title,lyrics, onOpen, onDelete, onEdit,idx,handleSetMusic }) => {
    return (
        <tr onClick={() => onOpen(musicId)}
            ...
            <td className="flex px-3 py-3">     
                <span style={styles.editBtn} onClick={() => onEdit(musicId)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="m-0 w-6 h-6 hover:scale-110 transition-transform">
                ...
                <span>
                <svg onClick={()=>handleSetMusic(musicId)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:scale-110 transition-transform hover:cursor-pointer">
